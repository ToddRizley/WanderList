...
def make_seeds
  ...
  def make_flights
     Flight.create( airline: "American", flight_number: "efgh", departure_date: '2016-03-19', arrival_date: '2016-03-19', price: 200.00, departure_airport_id: 2, arrival_airport_id: 3 )
